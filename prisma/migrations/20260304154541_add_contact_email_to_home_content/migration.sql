...
CREATE TABLE "new_HomeContent" (
    ...
    "photoUrl" TEXT,
    "contactEmail" TEXT NOT NULL DEFAULT 'noahvanboven@gmail.com',
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_HomeContent" ("aboutSection", "heroSubtitle", "id", "photoUrl", "startQuoteDoc", "updatedAt") SELECT "aboutSection", "heroSubtitle", "id", "photoUrl", "startQuoteDoc", "updatedAt" FROM "HomeContent";
