<script lang="ts">
	...
	// Restore field values after a failed submission
	...
	>
		...
		<section class="form-section">
			...
			<div class="field-row">
				...
				<label class="field">
					<span>Subtitle</span>
					<input type="text" name="subtitle" value={v?.subtitle ?? ''} required maxlength={400} />
				</label>
			</div>
		</section>
		...
		<section class="form-section">
			...
			<div class="field-row">
				<label class="field">
					<span>Client</span>
					<input type="text" name="client" value={v?.client ?? ''} required maxlength={200} />
				</label>
				<label class="field">
					<span>Year</span>
					<input type="text" name="year" value={v?.year ?? ''} required maxlength={20} placeholder="2025" />
				</label>
			</div>
			<div class="field-row">
				<label class="field">
					<span>Services</span>
					<input type="text" name="services" value={v?.services ?? ''} required maxlength={400} placeholder="Design, Development" />
				</label>
				<label class="field">
					<span>Technology</span>
					<input type="text" name="technology" value={v?.technology ?? ''} required maxlength={400} placeholder="SvelteKit, Prisma" />
				</label>
			</div>
		</section>
		...
		<section class="form-section">
			...
			<div class="field-row">
				<label class="field">
					<span>Demo URL</span>
					<input type="text" name="demoUrl" value={v?.demoUrl ?? ''} required maxlength={500} placeholder="https://example.com" />
				</label>
				<label class="field">
					<span>GitHub URL <span class="optional">(optional)</span></span>
					<input type="text" name="githubUrl" value={v?.githubUrl ?? ''} maxlength={500} placeholder="https://github.com/..." />
				</label>
			</div>
			<label class="field">
		...
		<div class="form-actions">
			...
			<button type="submit" disabled={!editorReady}>Create project</button>
		</div>
	</form>
</div>
